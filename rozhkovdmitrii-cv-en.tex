  ...
  \resumeSubHeadingListStart
    \small{\item{
        ...
        \textbf{Tooling: }\begin{itemize}[topsep=0pt,itemsep=0.1pt]
            ...
            \item\textbf{Test and Debug: }{ sanitizing, mock-all, google test, google mock, boost test framework, cucumber; wireshark(tshark), netcat, tcpreplay, strace; TDD/BDD }
...
\section{Employment History}
  ...
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
        ...
        {Making \emph{\href{https://www.myseven.io/}{\color{blue}My Seven}} platform that is aimed to provide efficient celebrity and fun base relations.}{Dec 2022 \textbf{--} present}
        \resumeItemListStart
